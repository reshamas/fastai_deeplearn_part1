...
- RT:  And the next question is, am I correct in thinking that this language model was built on word embeddings?  Would it be valuable to try this with phrase or sound 
